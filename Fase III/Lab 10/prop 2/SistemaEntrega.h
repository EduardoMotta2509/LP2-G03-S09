...
public:
    ...
    void ordenarEImprimirParadas() {
        vector<T> copia = vector<T>(puntosParada.begin(), puntosParada.end());
        ...
        cout << "Puntos de parada ordenados: ";
        for (const auto& val : copia) {
            cout << val << " ";
        }
        cout << endl;
    }
